...
const page = (props: Props) => {
  return (
    <div className="p-10 sm:p-20 flex flex-col items-center gap-16 ">
      ...
      <div className="w-full flex flex-col items-center">
        <h3 className="text-xl py-6 font-normal text-logo">OUR SERVICES</h3>
        <div className="flex gap-5">
          <div className="bg-logo/50">
      ...
      <div className="w-full flex flex-col items-center">
        <h3 className="text-xl py-6 font-normal text-logo">OUR STRENGTHS</h3>
        <div>
      ...
      <div className="w-full flex flex-col items-center">
        <h3 className="text-xl py-6 font-normal text-logo">OUR SUCCESS STORIES</h3>

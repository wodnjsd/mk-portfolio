    ...
    <main className="flex flex-col">
      ...
      <div className='py-12 sm:py-20 lg:py-0 xs:px-8 sm:px-16 lg:px-0 relative text-neutral-50'>
        <div className='flex flex-col items-center md:flex-row'>
          ...
          <div className='lg:w-1/2 px-6 xl:px-20 flex flex-col gap-4 xl:gap-8 justify-center items-center'>
        ...
        <div className='flex flex-col md:flex-row pt-4 lg:pt-0'>
          <div className='lg:w-1/2 px-6 lg:px-12 xl:px-20 flex flex-col gap-4 xl:gap-8 justify-center items-center'>
